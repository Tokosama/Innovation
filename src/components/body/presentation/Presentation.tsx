      ...
      <div className="border-r-2 col-span-2 pr-16">
        ...
        <div className="grid grid-cols-2 py-16">
          <div className="flex justify-end">
            <div className="border-2 border-[#FF0E47] text-base flex justify-center  bg-[#FF0E47]  items-center w-9 h-9 ml-2  text-white ">
              1
            </div>
            <div className="border-2 border-[#FF0E47] text-base flex justify-center   items-center w-9 h-9 ml-2 ">
              2
            </div>
            <div className="border-2 border-[#FF0E47] text-base flex justify-center   items-center w-9 h-9 ml-2 ">
              2
          ...
          <div className="flex justify-end">
            <div className="border-2 border-[#FF0E47] text-base flex justify-center   items-center px-7 py-2 ml-2 ">
